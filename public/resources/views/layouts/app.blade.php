        ...
        @else
            ...
            <div class="hidden lg:flex lg:flex-shrink-0">
                ...
                <div class="flex flex-col h-0 flex-1 border-r border-gray-200 bg-gray-100">
                    ...
                    <nav class="mt-5 flex-1" aria-label="Sidebar">
                        ...
                        <a href="/admin/home" class="@if(Request::segment(2) == 'home') bg-gray-200 @endif  text-gray-900 group flex items-center px-2 py-2 text-sm font-medium rounded-md">
                        ...
                        <a href="/admin/users" class="@if(Request::segment(2) == 'users') bg-gray-200 @endif text-gray-600 hover:bg-gray-50 hover:text-gray-900 group flex items-center px-2 py-2 text-sm font-medium rounded-md">
                        ...
                        <a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="text-gray-600 hover:bg-gray-50 hover:text-gray-900 group flex items-center px-2 py-2 text-sm font-medium rounded-md">
                            <!-- Heroicon name: outline/map -->
                            <!-- <svg class="text-gray-400 group-hover:text-gray-500 mr-3 h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7" />
                            </svg> -->
                            <svg class="text-gray-400 group-hover:text-gray-500 mr-3 h-6 w-6"  xmlns="http://www.w3.org/2000/svg"fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 3h4a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-4M10 17l5-5-5-5M13.8 12H3"/></svg>
                            Logout
                        </a>
                    ...
                    <div class="flex-shrink-0 flex border-t border-gray-200 p-4">
                    <a href="/admin/profile" class="flex-shrink-0 w-full group block">
                        <div class="flex items-center">
                        <div>
            ...
            <div class="flex flex-col min-w-0 flex-1 overflow-hidden">
                ...
                <div class="flex items-center justify-between bg-gray-50 border-b border-gray-200 px-4 py-1.5">
                    ...
                    <div>
                    <button type="button" @click="open = true" class="-mr-3 h-12 w-12 inline-flex items-center justify-center rounded-md text-gray-500 hover:text-gray-900">
            ...
            <div class="max-w-7xl mx-auto px-2 sm:px-4 lg:px-8">
                ...
                <div class="hidden lg:ml-4 lg:flex lg:items-center">
                    ...
                    <div>
                        ...
                        <img class="h-8 w-8 rounded-full" src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixqx=ra6XWadO7b&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="">
                        </button>
                    </div>
            ...
            <div class="lg:hidden" id="mobile-menu">
                ...
                <div class="flex items-center px-4">
                    ...
                    <img class="h-10 w-10 rounded-full" src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixqx=ra6XWadO7b&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="">
                    </div>
                    <div class="ml-3">
